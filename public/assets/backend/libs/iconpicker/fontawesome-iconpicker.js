...
(function (e) {
	...
	t.defaultOptions = c.extend(t.defaultOptions, {
		icons: [{
			...
			title: "fas fa-fw fa-ad",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-address-book",
			searchTerms: []
		}, {
			title: "far fa-address-book",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-address-card",
			searchTerms: []
		}, {
			title: "far fa-address-card",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-adjust",
			...
			title: "fas fa-fw fa-air-freshener",
			searchTerms: []
		}, {
			title: "fab fa-algolia",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-align-center",
			searchTerms: ["middle", "text"]
		}, {
			title: "fas fa-fw fa-align-justify",
			searchTerms: ["text"]
		}, {
			title: "fas fa-fw fa-align-left",
			searchTerms: ["text"]
		}, {
			title: "fas fa-fw fa-align-right",
			searchTerms: ["text"]
		}, {
			title: "fab fa-alipay",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-allergies",
			...
			title: "fas fa-fw fa-ambulance",
			searchTerms: ["help", "machine", "support", "vehicle"]
		}, {
			title: "fas fa-fw fa-american-sign-language-interpreting",
			searchTerms: []
		}, {
			title: "fab fa-amilia",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-anchor",
			searchTerms: ["link"]
		}, {
			...
			title: "fas fa-fw fa-angle-double-down",
			searchTerms: ["arrows"]
		}, {
			title: "fas fa-fw fa-angle-double-left",
			searchTerms: ["arrows", "back", "laquo", "previous", "quote"]
		}, {
			title: "fas fa-fw fa-angle-double-right",
			searchTerms: ["arrows", "forward", "next", "quote", "raquo"]
		}, {
			title: "fas fa-fw fa-angle-double-up",
			searchTerms: ["arrows"]
		}, {
			title: "fas fa-fw fa-angle-down",
			searchTerms: ["arrow"]
		}, {
			title: "fas fa-fw fa-angle-left",
			searchTerms: ["arrow", "back", "previous"]
		}, {
			title: "fas fa-fw fa-angle-right",
			searchTerms: ["arrow", "forward", "next"]
		}, {
			title: "fas fa-fw fa-angle-up",
			searchTerms: ["arrow"]
		}, {
			title: "fas fa-fw fa-angry",
			...
			title: "fas fa-fw fa-apple-alt",
			searchTerms: ["fall", "food", "fruit", "fuji", "macintosh", "seasonal"]
		}, {
			title: "fab fa-apple-pay",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-archive",
			searchTerms: ["box", "package", "storage"]
		}, {
			title: "fas fa-fw fa-archway",
			searchTerms: ["arc", "monument", "road", "street"]
		}, {
			title: "fas fa-fw fa-arrow-alt-circle-down",
			searchTerms: ["arrow-circle-o-down", "download"]
		}, {
			title: "far fa-arrow-alt-circle-down",
			searchTerms: ["arrow-circle-o-down", "download"]
		}, {
			title: "fas fa-fw fa-arrow-alt-circle-left",
			searchTerms: ["arrow-circle-o-left", "back", "previous"]
		}, {
			title: "far fa-arrow-alt-circle-left",
			searchTerms: ["arrow-circle-o-left", "back", "previous"]
		}, {
			title: "fas fa-fw fa-arrow-alt-circle-right",
			searchTerms: ["arrow-circle-o-right", "forward", "next"]
		}, {
			title: "far fa-arrow-alt-circle-right",
			searchTerms: ["arrow-circle-o-right", "forward", "next"]
		}, {
			title: "fas fa-fw fa-arrow-alt-circle-up",
			searchTerms: ["arrow-circle-o-up"]
		}, {
			title: "far fa-arrow-alt-circle-up",
			searchTerms: ["arrow-circle-o-up"]
		}, {
			title: "fas fa-fw fa-arrow-circle-down",
			searchTerms: ["download"]
		}, {
			title: "fas fa-fw fa-arrow-circle-left",
			searchTerms: ["back", "previous"]
		}, {
			title: "fas fa-fw fa-arrow-circle-right",
			searchTerms: ["forward", "next"]
		}, {
			title: "fas fa-fw fa-arrow-circle-up",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-arrow-down",
			searchTerms: ["download"]
		}, {
			title: "fas fa-fw fa-arrow-left",
			searchTerms: ["back", "previous"]
		}, {
			title: "fas fa-fw fa-arrow-right",
			searchTerms: ["forward", "next"]
		}, {
			title: "fas fa-fw fa-arrow-up",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-arrows-alt",
			searchTerms: ["arrow", "arrows", "bigger", "enlarge", "expand", "fullscreen", "move", "position", "reorder", "resize"]
		}, {
			title: "fas fa-fw fa-arrows-alt-h",
			searchTerms: ["arrows-h", "resize"]
		}, {
			title: "fas fa-fw fa-arrows-alt-v",
			searchTerms: ["arrows-v", "resize"]
		}, {
			title: "fas fa-fw fa-assistive-listening-systems",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-asterisk",
			searchTerms: ["details"]
		}, {
			title: "fab fa-asymmetrik",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-at",
			searchTerms: ["e-mail", "email"]
		}, {
			title: "fas fa-fw fa-atlas",
			searchTerms: ["book", "directions", "geography", "map", "wayfinding"]
		}, {
			title: "fas fa-fw fa-atom",
			searchTerms: ["atheism", "chemistry", "science"]
		}, {
			title: "fab fa-audible",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-audio-description",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-award",
			searchTerms: ["honor", "praise", "prize", "recognition", "ribbon"]
		}, {
			title: "fab fa-aws",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-backspace",
			searchTerms: ["command", "delete", "keyboard", "undo"]
		}, {
			title: "fas fa-fw fa-backward",
			searchTerms: ["previous", "rewind"]
		}, {
			title: "fas fa-fw fa-balance-scale",
			searchTerms: ["balanced", "justice", "legal", "measure", "weight"]
		}, {
			title: "fas fa-fw fa-ban",
			searchTerms: ["abort", "ban", "block", "cancel", "delete", "hide", "prohibit", "remove", "stop", "trash"]
		}, {
			title: "fas fa-fw fa-band-aid",
			searchTerms: ["bandage", "boo boo", "ouch"]
		}, {
			title: "fab fa-bandcamp",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-barcode",
			searchTerms: ["scan"]
		}, {
			title: "fas fa-fw fa-bars",
			searchTerms: ["checklist", "drag", "hamburger", "list", "menu", "nav", "navigation", "ol", "reorder", "settings", "todo", "ul"]
		}, {
			title: "fas fa-fw fa-baseball-ball",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-basketball-ball",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-bath",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-battery-empty",
			searchTerms: ["power", "status"]
		}, {
			title: "fas fa-fw fa-battery-full",
			searchTerms: ["power", "status"]
		}, {
			title: "fas fa-fw fa-battery-half",
			searchTerms: ["power", "status"]
		}, {
			title: "fas fa-fw fa-battery-quarter",
			searchTerms: ["power", "status"]
		}, {
			title: "fas fa-fw fa-battery-three-quarters",
			searchTerms: ["power", "status"]
		}, {
			title: "fas fa-fw fa-bed",
			searchTerms: ["lodging", "sleep", "travel"]
		}, {
			title: "fas fa-fw fa-beer",
			...
			title: "fas fa-fw fa-blender",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-blender-phone",
			searchTerms: ["appliance", "fantasy", "silly"]
		}, {
			title: "fas fa-fw fa-blind",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-bold",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-bolt",
			searchTerms: ["electricity", "lightning", "weather", "zap"]
		}, {
			title: "fas fa-fw fa-bomb",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-bone",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-bong",
			searchTerms: ["aparatus", "cannabis", "marijuana", "pipe", "smoke", "smoking"]
		}, {
			title: "fas fa-fw fa-book",
			searchTerms: ["documentation", "read"]
		}, {
			title: "fas fa-fw fa-book-dead",
			...
			title: "fas fa-fw fa-certificate",
			searchTerms: ["badge", "star"]
		}, {
			title: "fas fa-fw fa-chair",
			searchTerms: ["furniture", "seat"]
		}, {
			title: "fas fa-fw fa-chalkboard",
			searchTerms: ["blackboard", "learning", "school", "teaching", "whiteboard", "writing"]
		}, {
			title: "fas fa-fw fa-chalkboard-teacher",
			searchTerms: ["blackboard", "instructor", "learning", "professor", "school", "whiteboard", "writing"]
		}, {
			title: "fas fa-fw fa-charging-station",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chart-area",
			searchTerms: ["analytics", "area-chart", "graph"]
		}, {
			title: "fas fa-fw fa-chart-bar",
			searchTerms: ["analytics", "bar-chart", "graph"]
		}, {
			title: "far fa-chart-bar",
			searchTerms: ["analytics", "bar-chart", "graph"]
		}, {
			title: "fas fa-fw fa-chart-line",
			searchTerms: ["activity", "analytics", "dashboard", "graph", "line-chart"]
		}, {
			title: "fas fa-fw fa-chart-pie",
			searchTerms: ["analytics", "graph", "pie-chart"]
		}, {
			title: "fas fa-fw fa-check",
			searchTerms: ["accept", "agree", "checkmark", "confirm", "correct", "done", "notice", "notification", "notify", "ok", "select", "success", "tick", "todo", "yes"]
		}, {
			title: "fas fa-fw fa-check-circle",
			searchTerms: ["accept", "agree", "confirm", "correct", "done", "ok", "select", "success", "todo", "yes"]
		}, {
			title: "far fa-check-circle",
			searchTerms: ["accept", "agree", "confirm", "correct", "done", "ok", "select", "success", "todo", "yes"]
		}, {
			title: "fas fa-fw fa-check-double",
			searchTerms: ["accept", "agree", "checkmark", "confirm", "correct", "done", "notice", "notification", "notify", "ok", "select", "success", "tick", "todo"]
		}, {
			title: "fas fa-fw fa-check-square",
			searchTerms: ["accept", "agree", "checkmark", "confirm", "correct", "done", "ok", "select", "success", "todo", "yes"]
		}, {
			title: "far fa-check-square",
			searchTerms: ["accept", "agree", "checkmark", "confirm", "correct", "done", "ok", "select", "success", "todo", "yes"]
		}, {
			title: "fas fa-fw fa-chess",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-bishop",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-board",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-king",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-knight",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-pawn",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-queen",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chess-rook",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chevron-circle-down",
			searchTerms: ["arrow", "dropdown", "menu", "more"]
		}, {
			title: "fas fa-fw fa-chevron-circle-left",
			searchTerms: ["arrow", "back", "previous"]
		}, {
			title: "fas fa-fw fa-chevron-circle-right",
			searchTerms: ["arrow", "forward", "next"]
		}, {
			title: "fas fa-fw fa-chevron-circle-up",
			searchTerms: ["arrow"]
		}, {
			title: "fas fa-fw fa-chevron-down",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-chevron-left",
			searchTerms: ["back", "bracket", "previous"]
		}, {
			title: "fas fa-fw fa-chevron-right",
			searchTerms: ["bracket", "forward", "next"]
		}, {
			title: "fas fa-fw fa-chevron-up",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-child",
			searchTerms: []
		}, {
			title: "fab fa-chrome",
			searchTerms: ["browser"]
		}, {
			title: "fas fa-fw fa-church",
			searchTerms: ["building", "community", "religion"]
		}, {
			title: "fas fa-fw fa-circle",
			searchTerms: ["circle-thin", "dot", "notification"]
		}, {
			title: "far fa-circle",
			searchTerms: ["circle-thin", "dot", "notification"]
		}, {
			title: "fas fa-fw fa-circle-notch",
			searchTerms: ["circle-o-notch"]
		}, {
			title: "fas fa-fw fa-city",
			searchTerms: ["buildings", "busy", "skyscrapers", "urban", "windows"]
		}, {
			title: "fas fa-fw fa-clipboard",
			searchTerms: ["paste"]
		}, {
			title: "far fa-clipboard",
			searchTerms: ["paste"]
		}, {
			title: "fas fa-fw fa-clipboard-check",
			searchTerms: ["accept", "agree", "confirm", "done", "ok", "select", "success", "todo", "yes"]
		}, {
			title: "fas fa-fw fa-clipboard-list",
			searchTerms: ["checklist", "completed", "done", "finished", "intinerary", "ol", "schedule", "todo", "ul"]
		}, {
			title: "fas fa-fw fa-clock",
			searchTerms: ["date", "late", "schedule", "timer", "timestamp", "watch"]
		}, {
			title: "far fa-clock",
			searchTerms: ["date", "late", "schedule", "timer", "timestamp", "watch"]
		}, {
			title: "fas fa-fw fa-clone",
			searchTerms: ["copy", "duplicate"]
		}, {
			title: "far fa-clone",
			searchTerms: ["copy", "duplicate"]
		}, {
			title: "fas fa-fw fa-closed-captioning",
			searchTerms: ["cc"]
		}, {
			title: "far fa-closed-captioning",
			searchTerms: ["cc"]
		}, {
			title: "fas fa-fw fa-cloud",
			searchTerms: ["save"]
		}, {
			title: "fas fa-fw fa-cloud-download-alt",
			searchTerms: ["import"]
		}, {
			title: "fas fa-fw fa-cloud-meatball",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-cloud-moon",
			searchTerms: ["crescent", "evening", "halloween", "holiday", "lunar", "night", "sky"]
		}, {
			title: "fas fa-fw fa-cloud-moon-rain",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-cloud-rain",
			searchTerms: ["precipitation"]
		}, {
			title: "fas fa-fw fa-cloud-showers-heavy",
			searchTerms: ["precipitation", "rain", "storm"]
		}, {
			title: "fas fa-fw fa-cloud-sun",
			searchTerms: ["day", "daytime", "fall", "outdoors", "seasonal"]
		}, {
			title: "fas fa-fw fa-cloud-sun-rain",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-cloud-upload-alt",
			...
			title: "fas fa-fw fa-cocktail",
			searchTerms: ["alcohol", "beverage", "drink"]
		}, {
			title: "fas fa-fw fa-code",
			searchTerms: ["brackets", "html"]
		}, {
			title: "fas fa-fw fa-code-branch",
			...
			title: "fas fa-fw fa-comment-dollar",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-comment-dots",
			searchTerms: []
		}, {
			title: "far fa-comment-dots",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-comment-slash",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-comments",
			searchTerms: ["bubble", "chat", "conversation", "feedback", "message", "note", "notification", "sms", "speech", "texting"]
		}, {
			title: "far fa-comments",
			searchTerms: ["bubble", "chat", "conversation", "feedback", "message", "note", "notification", "sms", "speech", "texting"]
		}, {
			title: "fas fa-fw fa-comments-dollar",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-compact-disc",
			searchTerms: ["bluray", "cd", "disc", "media"]
		}, {
			title: "fas fa-fw fa-compass",
			searchTerms: ["directory", "location", "menu", "safari"]
		}, {
			title: "far fa-compass",
			searchTerms: ["directory", "location", "menu", "safari"]
		}, {
			title: "fas fa-fw fa-compress",
			searchTerms: ["collapse", "combine", "contract", "merge", "smaller"]
		}, {
			title: "fas fa-fw fa-concierge-bell",
			...
			title: "fas fa-fw fa-credit-card",
			...
			title: "fas fa-fw fa-crop",
			searchTerms: ["design"]
		}, {
			title: "fas fa-fw fa-crop-alt",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-cross",
			searchTerms: ["catholicism", "christianity"]
		}, {
			title: "fas fa-fw fa-crosshairs",
			searchTerms: ["gpd", "picker", "position"]
		}, {
			title: "fas fa-fw fa-crow",
			searchTerms: ["bird", "bullfrog", "fauna", "halloween", "holiday", "toad"]
		}, {
			title: "fas fa-fw fa-crown",
			searchTerms: []
		}, {
			title: "fab fa-css3",
			searchTerms: ["code"]
			...
			title: "fas fa-fw fa-cube",
			searchTerms: ["package"]
		}, {
			title: "fas fa-fw fa-cubes",
			searchTerms: ["packages"]
		}, {
			title: "fas fa-fw fa-cut",
			...
			title: "fas fa-fw fa-database",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-deaf",
			searchTerms: []
		}, {
			title: "fab fa-delicious",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-democrat",
			...
			title: "fas fa-fw fa-dharmachakra",
			searchTerms: ["buddhism", "buddhist", "wheel of dharma"]
		}, {
			title: "fas fa-fw fa-diagnoses",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-dice",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-d20",
			searchTerms: ["Dungeons & Dragons", "chance", "d&d", "dnd", "fantasy", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-d6",
			searchTerms: ["Dungeons & Dragons", "chance", "d&d", "dnd", "fantasy", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-five",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-four",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-one",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-six",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-three",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fas fa-fw fa-dice-two",
			searchTerms: ["chance", "gambling", "game", "roll"]
		}, {
			title: "fab fa-digg",
			searchTerms: []
			...
			title: "fas fa-fw fa-digital-tachograph",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-directions",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-divide",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-dizzy",
			searchTerms: ["dazed", "disapprove", "emoticon", "face"]
		}, {
			title: "far fa-dizzy",
			searchTerms: ["dazed", "disapprove", "emoticon", "face"]
		}, {
			title: "fas fa-fw fa-dna",
			...
			title: "fas fa-fw fa-dog",
			searchTerms: ["canine", "fauna", "mammmal", "pet", "pooch", "puppy", "woof"]
		}, {
			title: "fas fa-fw fa-dollar-sign",
			searchTerms: ["$", "dollar-sign", "money", "price", "usd"]
		}, {
			title: "fas fa-fw fa-dolly",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-dolly-flatbed",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-donate",
			searchTerms: ["generosity", "give"]
		}, {
			title: "fas fa-fw fa-door-closed",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-door-open",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-dot-circle",
			searchTerms: ["bullseye", "notification", "target"]
		}, {
			title: "far fa-dot-circle",
			searchTerms: ["bullseye", "notification", "target"]
		}, {
			title: "fas fa-fw fa-dove",
			searchTerms: ["bird", "fauna", "flying", "peace"]
		}, {
			title: "fas fa-fw fa-download",
			searchTerms: ["import"]
		}, {
			title: "fab fa-draft2digital",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-drafting-compass",
			searchTerms: ["mechanical drawing", "plot", "plotting"]
		}, {
			title: "fas fa-fw fa-dragon",
			searchTerms: ["Dungeons & Dragons", "d&d", "dnd", "fantasy"]
		}, {
			title: "fas fa-fw fa-draw-polygon",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-envelope",
			searchTerms: ["e-mail", "email", "letter", "mail", "message", "notification", "support"]
		}, {
			title: "far fa-envelope",
			searchTerms: ["e-mail", "email", "letter", "mail", "message", "notification", "support"]
		}, {
			title: "fas fa-fw fa-envelope-open",
			searchTerms: ["e-mail", "email", "letter", "mail", "message", "notification", "support"]
		}, {
			title: "far fa-envelope-open",
			searchTerms: ["e-mail", "email", "letter", "mail", "message", "notification", "support"]
		}, {
			title: "fas fa-fw fa-envelope-open-text",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-envelope-square",
			searchTerms: ["e-mail", "email", "letter", "mail", "message", "notification", "support"]
		}, {
			title: "fab fa-envira",
			searchTerms: ["leaf"]
		}, {
			title: "fas fa-fw fa-equals",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-eraser",
			...
			title: "fas fa-fw fa-fast-backward",
			searchTerms: ["beginning", "first", "previous", "rewind", "start"]
		}, {
			title: "fas fa-fw fa-fast-forward",
			searchTerms: ["end", "last", "next"]
		}, {
			title: "fas fa-fw fa-fax",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-feather",
			searchTerms: ["bird", "light", "plucked", "quill"]
		}, {
			title: "fas fa-fw fa-feather-alt",
			searchTerms: ["bird", "light", "plucked", "quill"]
		}, {
			title: "fas fa-fw fa-female",
			searchTerms: ["human", "person", "profile", "user", "woman"]
		}, {
			title: "fas fa-fw fa-fighter-jet",
			searchTerms: ["airplane", "fast", "fly", "goose", "maverick", "plane", "quick", "top gun", "transportation", "travel"]
		}, {
			title: "fas fa-fw fa-file",
			searchTerms: ["document", "new", "page", "pdf", "resume"]
		}, {
			title: "far fa-file",
			searchTerms: ["document", "new", "page", "pdf", "resume"]
		}, {
			title: "fas fa-fw fa-file-alt",
			searchTerms: ["document", "file-text", "invoice", "new", "page", "pdf"]
		}, {
			title: "far fa-file-alt",
			searchTerms: ["document", "file-text", "invoice", "new", "page", "pdf"]
		}, {
			title: "fas fa-fw fa-file-archive",
			searchTerms: [".zip", "bundle", "compress", "compression", "download", "zip"]
		}, {
			title: "far fa-file-archive",
			searchTerms: [".zip", "bundle", "compress", "compression", "download", "zip"]
		}, {
			title: "fas fa-fw fa-file-audio",
			searchTerms: []
		}, {
			title: "far fa-file-audio",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-code",
			searchTerms: []
		}, {
			title: "far fa-file-code",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-contract",
			searchTerms: ["agreement", "binding", "document", "legal", "signature"]
		}, {
			title: "fas fa-fw fa-file-csv",
			searchTerms: ["spreadsheets"]
		}, {
			title: "fas fa-fw fa-file-download",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-excel",
			searchTerms: []
		}, {
			title: "far fa-file-excel",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-export",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-image",
			searchTerms: []
		}, {
			title: "far fa-file-image",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-import",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-invoice",
			searchTerms: ["bill", "document", "receipt"]
		}, {
			title: "fas fa-fw fa-file-invoice-dollar",
			searchTerms: ["$", "bill", "document", "dollar-sign", "money", "receipt", "usd"]
		}, {
			title: "fas fa-fw fa-file-medical",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-medical-alt",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-pdf",
			searchTerms: []
		}, {
			title: "far fa-file-pdf",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-powerpoint",
			searchTerms: []
		}, {
			title: "far fa-file-powerpoint",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-prescription",
			searchTerms: ["drugs", "medical", "medicine", "rx"]
		}, {
			title: "fas fa-fw fa-file-signature",
			searchTerms: ["John Hancock", "contract", "document", "name"]
		}, {
			title: "fas fa-fw fa-file-upload",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-video",
			searchTerms: []
		}, {
			title: "far fa-file-video",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-file-word",
			searchTerms: []
		}, {
			title: "far fa-file-word",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-fill",
			searchTerms: ["bucket", "color", "paint", "paint bucket"]
		}, {
			title: "fas fa-fw fa-fill-drip",
			searchTerms: ["bucket", "color", "drop", "paint", "paint bucket", "spill"]
		}, {
			title: "fas fa-fw fa-film",
			searchTerms: ["movie"]
		}, {
			title: "fas fa-fw fa-filter",
			searchTerms: ["funnel", "options"]
		}, {
			title: "fas fa-fw fa-fingerprint",
			searchTerms: ["human", "id", "identification", "lock", "smudge", "touch", "unique", "unlock"]
		}, {
			title: "fas fa-fw fa-fire",
			searchTerms: ["caliente", "flame", "heat", "hot", "popular"]
		}, {
			title: "fas fa-fw fa-fire-extinguisher",
			searchTerms: []
		}, {
			title: "fab fa-firefox",
			searchTerms: ["browser"]
		}, {
			title: "fas fa-fw fa-first-aid",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-folder",
			searchTerms: []
		}, {
			title: "far fa-folder",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-folder-minus",
			searchTerms: ["archive", "delete", "negative", "remove"]
		}, {
			title: "fas fa-fw fa-folder-open",
			searchTerms: []
		}, {
			title: "far fa-folder-open",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-folder-plus",
			searchTerms: ["add", "create", "new", "positive"]
		}, {
			title: "fas fa-fw fa-font",
			searchTerms: ["text"]
		}, {
			...
			title: "fas fa-fw fa-font-awesome-logo-full",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-football-ball",
			...
			title: "fas fa-fw fa-funnel-dollar",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-futbol",
			...
			title: "fas fa-fw fa-gamepad",
			searchTerms: ["controller"]
		}, {
			title: "fas fa-fw fa-gas-pump",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-gavel",
			searchTerms: ["hammer", "judge", "lawyer", "opinion"]
		}, {
			title: "fas fa-fw fa-gem",
			searchTerms: ["diamond"]
		}, {
			title: "far fa-gem",
			searchTerms: ["diamond"]
		}, {
			title: "fas fa-fw fa-genderless",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-glass-martini",
			searchTerms: ["alcohol", "bar", "beverage", "drink", "glass", "liquor", "martini"]
		}, {
			title: "fas fa-fw fa-glass-martini-alt",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-glasses",
			...
			title: "fas fa-fw fa-globe-africa",
			searchTerms: ["all", "country", "earth", "global", "gps", "language", "localize", "location", "map", "online", "place", "planet", "translate", "travel", "world"]
		}, {
			title: "fas fa-fw fa-globe-americas",
			searchTerms: ["all", "country", "earth", "global", "gps", "language", "localize", "location", "map", "online", "place", "planet", "translate", "travel", "world"]
		}, {
			title: "fas fa-fw fa-globe-asia",
			searchTerms: ["all", "country", "earth", "global", "gps", "language", "localize", "location", "map", "online", "place", "planet", "translate", "travel", "world"]
		}, {
			title: "fab fa-gofore",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-golf-ball",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-gopuram",
			searchTerms: ["building", "entrance", "hinduism", "temple", "tower"]
		}, {
			title: "fas fa-fw fa-graduation-cap",
			...
			title: "fas fa-fw fa-history",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hockey-puck",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-home",
			...
			title: "fas fa-fw fa-horse",
			searchTerms: ["equus", "fauna", "mammmal", "neigh"]
		}, {
			title: "fas fa-fw fa-hospital",
			searchTerms: ["building", "emergency room", "medical center"]
		}, {
			title: "far fa-hospital",
			searchTerms: ["building", "emergency room", "medical center"]
		}, {
			title: "fas fa-fw fa-hospital-alt",
			searchTerms: ["building", "emergency room", "medical center"]
		}, {
			title: "fas fa-fw fa-hospital-symbol",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hot-tub",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hotel",
			searchTerms: ["building", "lodging"]
		}, {
			title: "fab fa-hotjar",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hourglass",
			searchTerms: []
		}, {
			title: "far fa-hourglass",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hourglass-end",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hourglass-half",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hourglass-start",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-house-damage",
			searchTerms: ["devastation", "home"]
		}, {
			title: "fab fa-houzz",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-hryvnia",
			searchTerms: ["money"]
		}, {
			title: "fab fa-html5",
			searchTerms: []
			...
			title: "fas fa-fw fa-i-cursor",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-id-badge",
			searchTerms: []
		}, {
			title: "far fa-id-badge",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-id-card",
			searchTerms: ["document", "identification", "issued"]
		}, {
			title: "far fa-id-card",
			searchTerms: ["document", "identification", "issued"]
		}, {
			title: "fas fa-fw fa-id-card-alt",
			searchTerms: ["demographics"]
		}, {
			title: "fas fa-fw fa-image",
			searchTerms: ["album", "photo", "picture"]
		}, {
			title: "far fa-image",
			searchTerms: ["album", "photo", "picture"]
		}, {
			title: "fas fa-fw fa-images",
			searchTerms: ["album", "photo", "picture"]
		}, {
			title: "far fa-images",
			searchTerms: ["album", "photo", "picture"]
			...
			title: "fas fa-fw fa-inbox",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-indent",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-industry",
			searchTerms: ["factory", "manufacturing"]
		}, {
			title: "fas fa-fw fa-infinity",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-info",
			searchTerms: ["details", "help", "information", "more"]
		}, {
			title: "fas fa-fw fa-info-circle",
			searchTerms: ["details", "help", "information", "more"]
		}, {
			...
			title: "fas fa-fw fa-laugh",
			searchTerms: ["LOL", "emoticon", "face", "laugh"]
		}, {
			title: "far fa-laugh",
			searchTerms: ["LOL", "emoticon", "face", "laugh"]
		}, {
			title: "fas fa-fw fa-laugh-beam",
			searchTerms: ["LOL", "emoticon", "face"]
		}, {
			title: "far fa-laugh-beam",
			searchTerms: ["LOL", "emoticon", "face"]
		}, {
			title: "fas fa-fw fa-laugh-squint",
			searchTerms: ["LOL", "emoticon", "face"]
		}, {
			title: "far fa-laugh-squint",
			searchTerms: ["LOL", "emoticon", "face"]
		}, {
			title: "fas fa-fw fa-laugh-wink",
			searchTerms: ["LOL", "emoticon", "face"]
		}, {
			title: "far fa-laugh-wink",
			searchTerms: ["LOL", "emoticon", "face"]
		}, {
			title: "fas fa-fw fa-layer-group",
			searchTerms: ["layers"]
		}, {
			title: "fas fa-fw fa-leaf",
			searchTerms: ["eco", "flora", "nature", "plant"]
		}, {
			title: "fab fa-leanpub",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-lemon",
			searchTerms: ["food"]
		}, {
			title: "far fa-lemon",
			searchTerms: ["food"]
			...
			title: "fas fa-fw fa-less-than",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-less-than-equal",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-level-down-alt",
			searchTerms: ["level-down"]
		}, {
			title: "fas fa-fw fa-level-up-alt",
			searchTerms: ["level-up"]
		}, {
			title: "fas fa-fw fa-life-ring",
			searchTerms: ["support"]
		}, {
			title: "far fa-life-ring",
			searchTerms: ["support"]
		}, {
			title: "fas fa-fw fa-lightbulb",
			...
			title: "fas fa-fw fa-lira-sign",
			searchTerms: ["try", "turkish"]
		}, {
			title: "fas fa-fw fa-list",
			searchTerms: ["checklist", "completed", "done", "finished", "ol", "todo", "ul"]
		}, {
			title: "fas fa-fw fa-list-alt",
			searchTerms: ["checklist", "completed", "done", "finished", "ol", "todo", "ul"]
		}, {
			title: "far fa-list-alt",
			searchTerms: ["checklist", "completed", "done", "finished", "ol", "todo", "ul"]
		}, {
			title: "fas fa-fw fa-list-ol",
			searchTerms: ["checklist", "list", "numbers", "ol", "todo", "ul"]
		}, {
			title: "fas fa-fw fa-list-ul",
			searchTerms: ["checklist", "list", "ol", "todo", "ul"]
		}, {
			title: "fas fa-fw fa-location-arrow",
			searchTerms: ["address", "coordinates", "gps", "location", "map", "place", "where"]
		}, {
			title: "fas fa-fw fa-lock",
			searchTerms: ["admin", "protect", "security"]
		}, {
			title: "fas fa-fw fa-lock-open",
			searchTerms: ["admin", "lock", "open", "password", "protect"]
		}, {
			title: "fas fa-fw fa-long-arrow-alt-down",
			searchTerms: ["long-arrow-down"]
		}, {
			title: "fas fa-fw fa-long-arrow-alt-left",
			searchTerms: ["back", "long-arrow-left", "previous"]
		}, {
			title: "fas fa-fw fa-long-arrow-alt-right",
			searchTerms: ["long-arrow-right"]
		}, {
			title: "fas fa-fw fa-long-arrow-alt-up",
			searchTerms: ["long-arrow-up"]
		}, {
			title: "fas fa-fw fa-low-vision",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-luggage-cart",
			searchTerms: []
		}, {
			title: "fab fa-lyft",
			searchTerms: []
			...
			title: "fas fa-fw fa-map-marked-alt",
			searchTerms: ["address", "coordinates", "destination", "gps", "localize", "location", "map", "paper", "pin", "place", "point of interest", "position", "route", "travel", "where"]
		}, {
			title: "fas fa-fw fa-map-marker",
			searchTerms: ["address", "coordinates", "gps", "localize", "location", "map", "pin", "place", "position", "travel", "where"]
		}, {
			title: "fas fa-fw fa-map-marker-alt",
			searchTerms: ["address", "coordinates", "gps", "localize", "location", "map", "pin", "place", "position", "travel", "where"]
		}, {
			title: "fas fa-fw fa-map-pin",
			searchTerms: ["address", "coordinates", "gps", "localize", "location", "map", "marker", "place", "position", "travel", "where"]
		}, {
			title: "fas fa-fw fa-map-signs",
			searchTerms: []
		}, {
			title: "fab fa-markdown",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-marker",
			searchTerms: ["edit", "sharpie", "update", "write"]
		}, {
			title: "fas fa-fw fa-mars",
			searchTerms: ["male"]
		}, {
			title: "fas fa-fw fa-mars-double",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-mars-stroke",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-mars-stroke-h",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-mars-stroke-v",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-mask",
			...
			title: "fas fa-fw fa-meh",
			searchTerms: ["emoticon", "face", "neutral", "rating"]
		}, {
			title: "far fa-meh",
			searchTerms: ["emoticon", "face", "neutral", "rating"]
		}, {
			title: "fas fa-fw fa-meh-blank",
			searchTerms: ["emoticon", "face", "neutral", "rating"]
		}, {
			title: "far fa-meh-blank",
			searchTerms: ["emoticon", "face", "neutral", "rating"]
		}, {
			title: "fas fa-fw fa-meh-rolling-eyes",
			searchTerms: ["emoticon", "face", "neutral", "rating"]
		}, {
			title: "far fa-meh-rolling-eyes",
			searchTerms: ["emoticon", "face", "neutral", "rating"]
		}, {
			title: "fas fa-fw fa-memory",
			searchTerms: ["DIMM", "RAM"]
		}, {
			title: "fas fa-fw fa-menorah",
			searchTerms: ["candle", "hanukkah", "jewish", "judaism", "light"]
		}, {
			title: "fas fa-fw fa-mercury",
			searchTerms: ["transgender"]
		}, {
			title: "fas fa-fw fa-meteor",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-microchip",
			searchTerms: ["cpu", "processor"]
		}, {
			title: "fas fa-fw fa-microphone",
			searchTerms: ["record", "sound", "voice"]
		}, {
			title: "fas fa-fw fa-microphone-alt",
			searchTerms: ["record", "sound", "voice"]
		}, {
			title: "fas fa-fw fa-microphone-alt-slash",
			searchTerms: ["disable", "mute", "record", "sound", "voice"]
		}, {
			title: "fas fa-fw fa-microphone-slash",
			searchTerms: ["disable", "mute", "record", "sound", "voice"]
		}, {
			title: "fas fa-fw fa-microscope",
			searchTerms: []
		}, {
			title: "fab fa-microsoft",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-minus",
			searchTerms: ["collapse", "delete", "hide", "minify", "negative", "remove", "trash"]
		}, {
			title: "fas fa-fw fa-minus-circle",
			searchTerms: ["delete", "hide", "negative", "remove", "trash"]
		}, {
			title: "fas fa-fw fa-minus-square",
			searchTerms: ["collapse", "delete", "hide", "minify", "negative", "remove", "trash"]
		}, {
			...
			title: "fas fa-fw fa-money-bill",
			searchTerms: ["buy", "cash", "checkout", "money", "payment", "price", "purchase"]
		}, {
			title: "fas fa-fw fa-money-bill-alt",
			searchTerms: ["buy", "cash", "checkout", "money", "payment", "price", "purchase"]
		}, {
			title: "far fa-money-bill-alt",
			searchTerms: ["buy", "cash", "checkout", "money", "payment", "price", "purchase"]
		}, {
			title: "fas fa-fw fa-money-bill-wave",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-money-bill-wave-alt",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-money-check",
			searchTerms: ["bank check", "cheque"]
		}, {
			title: "fas fa-fw fa-money-check-alt",
			searchTerms: ["bank check", "cheque"]
		}, {
			title: "fas fa-fw fa-monument",
			searchTerms: ["building", "historic", "memoroable"]
		}, {
			title: "fas fa-fw fa-moon",
			searchTerms: ["contrast", "crescent", "darker", "lunar", "night"]
		}, {
			title: "far fa-moon",
			searchTerms: ["contrast", "crescent", "darker", "lunar", "night"]
		}, {
			title: "fas fa-fw fa-mortar-pestle",
			searchTerms: ["crush", "culinary", "grind", "medical", "mix", "spices"]
		}, {
			title: "fas fa-fw fa-mosque",
			searchTerms: ["building", "islam", "muslim"]
		}, {
			title: "fas fa-fw fa-motorcycle",
			searchTerms: ["bike", "machine", "transportation", "vehicle"]
		}, {
			title: "fas fa-fw fa-mountain",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-mouse-pointer",
			searchTerms: ["select"]
		}, {
			title: "fas fa-fw fa-music",
			...
			title: "fas fa-fw fa-network-wired",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-neuter",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-newspaper",
			...
			title: "fas fa-fw fa-not-equal",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-notes-medical",
			searchTerms: []
		}, {
			title: "fab fa-npm",
			searchTerms: []
			...
			title: "fas fa-fw fa-object-group",
			searchTerms: ["design"]
		}, {
			title: "far fa-object-group",
			searchTerms: ["design"]
		}, {
			title: "fas fa-fw fa-object-ungroup",
			searchTerms: ["design"]
		}, {
			...
			title: "fas fa-fw fa-oil-can",
			searchTerms: []
		}, {
			title: "fab fa-old-republic",
			searchTerms: ["politics", "star wars"]
		}, {
			title: "fas fa-fw fa-om",
			...
			title: "fas fa-fw fa-otter",
			searchTerms: ["fauna", "mammmal"]
		}, {
			title: "fas fa-fw fa-outdent",
			searchTerms: []
		}, {
			title: "fab fa-page4",
			searchTerms: []
			...
			title: "fas fa-fw fa-paint-brush",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-paint-roller",
			searchTerms: ["brush", "painting", "tool"]
		}, {
			title: "fas fa-fw fa-palette",
			searchTerms: ["colors", "painting"]
		}, {
			title: "fab fa-palfed",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-pallet",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-paper-plane",
			searchTerms: []
		}, {
			title: "far fa-paper-plane",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-paperclip",
			searchTerms: ["attachment"]
		}, {
			title: "fas fa-fw fa-parachute-box",
			searchTerms: ["aid", "assistance", "rescue", "supplies"]
		}, {
			title: "fas fa-fw fa-paragraph",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-parking",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-passport",
			searchTerms: ["document", "identification", "issued"]
		}, {
			title: "fas fa-fw fa-pastafarianism",
			searchTerms: ["agnosticism", "atheism", "flying spaghetti monster", "fsm"]
		}, {
			title: "fas fa-fw fa-paste",
			searchTerms: ["clipboard", "copy"]
		}, {
			title: "fab fa-patreon",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-pause",
			searchTerms: ["wait"]
		}, {
			title: "fas fa-fw fa-pause-circle",
			searchTerms: []
		}, {
			title: "far fa-pause-circle",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-paw",
			searchTerms: ["animal", "pet"]
		}, {
			title: "fab fa-paypal",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-peace",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-pen",
			searchTerms: ["design", "edit", "update", "write"]
		}, {
			title: "fas fa-fw fa-pen-alt",
			searchTerms: ["design", "edit", "update", "write"]
		}, {
			title: "fas fa-fw fa-pen-fancy",
			searchTerms: ["design", "edit", "fountain pen", "update", "write"]
		}, {
			title: "fas fa-fw fa-pen-nib",
			searchTerms: ["design", "edit", "fountain pen", "update", "write"]
		}, {
			title: "fas fa-fw fa-pen-square",
			searchTerms: ["edit", "pencil-square", "update", "write"]
		}, {
			title: "fas fa-fw fa-pencil-alt",
			searchTerms: ["design", "edit", "pencil", "update", "write"]
		}, {
			title: "fas fa-fw fa-pencil-ruler",
			searchTerms: []
		}, {
			title: "fab fa-penny-arcade",
			searchTerms: ["Dungeons & Dragons", "d&d", "dnd", "fantasy", "game", "gaming", "pax", "tabletop"]
		}, {
			title: "fas fa-fw fa-people-carry",
			searchTerms: ["movers"]
		}, {
			title: "fas fa-fw fa-percent",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-percentage",
			searchTerms: []
		}, {
			title: "fab fa-periscope",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-person-booth",
			...
			title: "fas fa-fw fa-phone",
			searchTerms: ["call", "earphone", "number", "support", "telephone", "voice"]
		}, {
			title: "fas fa-fw fa-phone-slash",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-phone-square",
			searchTerms: ["call", "number", "support", "telephone", "voice"]
		}, {
			title: "fas fa-fw fa-phone-volume",
			...
			title: "fas fa-fw fa-piggy-bank",
			searchTerms: ["save", "savings"]
		}, {
			title: "fas fa-fw fa-pills",
			searchTerms: ["drugs", "medicine"]
		}, {
			...
			title: "fas fa-fw fa-plug",
			searchTerms: ["connect", "online", "power"]
		}, {
			title: "fas fa-fw fa-plus",
			searchTerms: ["add", "create", "expand", "new", "positive"]
		}, {
			title: "fas fa-fw fa-plus-circle",
			searchTerms: ["add", "create", "expand", "new", "positive"]
		}, {
			title: "fas fa-fw fa-plus-square",
			searchTerms: ["add", "create", "expand", "new", "positive"]
		}, {
			title: "far fa-plus-square",
			searchTerms: ["add", "create", "expand", "new", "positive"]
		}, {
			title: "fas fa-fw fa-podcast",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-poll",
			searchTerms: ["results", "survey", "vote", "voting"]
		}, {
			title: "fas fa-fw fa-poll-h",
			searchTerms: ["results", "survey", "vote", "voting"]
		}, {
			title: "fas fa-fw fa-poo",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-poo-storm",
			searchTerms: ["mess", "poop", "shit"]
		}, {
			title: "fas fa-fw fa-poop",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-portrait",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-pound-sign",
			searchTerms: ["gbp"]
		}, {
			title: "fas fa-fw fa-power-off",
			searchTerms: ["on", "reboot", "restart"]
		}, {
			title: "fas fa-fw fa-pray",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-praying-hands",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-prescription",
			searchTerms: ["drugs", "medical", "medicine", "rx"]
		}, {
			title: "fas fa-fw fa-prescription-bottle",
			searchTerms: ["drugs", "medical", "medicine", "rx"]
		}, {
			title: "fas fa-fw fa-prescription-bottle-alt",
			searchTerms: ["drugs", "medical", "medicine", "rx"]
		}, {
			title: "fas fa-fw fa-print",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-procedures",
			searchTerms: []
		}, {
			title: "fab fa-product-hunt",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-project-diagram",
			searchTerms: []
		}, {
			title: "fab fa-pushed",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-puzzle-piece",
			...
			title: "fas fa-fw fa-qrcode",
			searchTerms: ["scan"]
		}, {
			title: "fas fa-fw fa-question",
			searchTerms: ["help", "information", "support", "unknown"]
		}, {
			title: "fas fa-fw fa-question-circle",
			searchTerms: ["help", "information", "support", "unknown"]
		}, {
			title: "far fa-question-circle",
			searchTerms: ["help", "information", "support", "unknown"]
		}, {
			title: "fas fa-fw fa-quidditch",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-quote-left",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-quote-right",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-quran",
			searchTerms: ["book", "islam", "muslim"]
		}, {
			title: "fab fa-r-project",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-rainbow",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-random",
			...
			title: "fas fa-fw fa-receipt",
			searchTerms: ["check", "invoice", "table"]
		}, {
			title: "fas fa-fw fa-recycle",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-redo",
			searchTerms: ["forward", "refresh", "reload", "repeat"]
		}, {
			title: "fas fa-fw fa-redo-alt",
			searchTerms: ["forward", "refresh", "reload", "repeat"]
		}, {
			title: "fas fa-fw fa-registered",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-reply",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-reply-all",
			searchTerms: []
		}, {
			title: "fab fa-replyd",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-republican",
			...
			title: "fas fa-fw fa-retweet",
			searchTerms: ["refresh", "reload", "share", "swap"]
		}, {
			title: "fab fa-rev",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-ribbon",
			searchTerms: ["badge", "cause", "lapel", "pin"]
		}, {
			title: "fas fa-fw fa-ring",
			searchTerms: ["Dungeons & Dragons", "Gollum", "band", "binding", "d&d", "dnd", "fantasy", "jewelry", "precious"]
		}, {
			title: "fas fa-fw fa-road",
			searchTerms: ["street"]
		}, {
			title: "fas fa-fw fa-robot",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-rocket",
			searchTerms: ["app"]
		}, {
			...
			title: "fas fa-fw fa-route",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-rss",
			searchTerms: ["blog"]
		}, {
			title: "fas fa-fw fa-rss-square",
			searchTerms: ["blog", "feed"]
		}, {
			title: "fas fa-fw fa-ruble-sign",
			searchTerms: ["rub"]
		}, {
			title: "fas fa-fw fa-ruler",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-ruler-combined",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-ruler-horizontal",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-ruler-vertical",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-running",
			searchTerms: ["jog", "sprint"]
		}, {
			title: "fas fa-fw fa-rupee-sign",
			searchTerms: ["indian", "inr"]
		}, {
			title: "fas fa-fw fa-sad-cry",
			searchTerms: ["emoticon", "face", "tear", "tears"]
		}, {
			title: "far fa-sad-cry",
			searchTerms: ["emoticon", "face", "tear", "tears"]
		}, {
			title: "fas fa-fw fa-sad-tear",
			searchTerms: ["emoticon", "face", "tear", "tears"]
		}, {
			...
			title: "fas fa-fw fa-school",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-screwdriver",
			searchTerms: ["admin", "fix", "repair", "settings", "tool"]
		}, {
			title: "fab fa-scribd",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-scroll",
			searchTerms: ["Dungeons & Dragons", "announcement", "d&d", "dnd", "fantasy", "paper"]
		}, {
			title: "fas fa-fw fa-search",
			searchTerms: ["bigger", "enlarge", "magnify", "preview", "zoom"]
		}, {
			title: "fas fa-fw fa-search-dollar",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-search-location",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-search-minus",
			searchTerms: ["minify", "negative", "smaller", "zoom", "zoom out"]
		}, {
			title: "fas fa-fw fa-search-plus",
			searchTerms: ["bigger", "enlarge", "magnify", "positive", "zoom", "zoom in"]
		}, {
			title: "fab fa-searchengin",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-seedling",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-server",
			searchTerms: ["cpu"]
		}, {
			title: "fab fa-servicestack",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-shapes",
			searchTerms: ["circle", "square", "triangle"]
		}, {
			title: "fas fa-fw fa-share",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-share-alt",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-share-alt-square",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-share-square",
			searchTerms: ["send", "social"]
		}, {
			title: "far fa-share-square",
			searchTerms: ["send", "social"]
		}, {
			title: "fas fa-fw fa-shekel-sign",
			searchTerms: ["ils"]
		}, {
			title: "fas fa-fw fa-shield-alt",
			searchTerms: ["achievement", "award", "block", "defend", "security", "winner"]
		}, {
			title: "fas fa-fw fa-ship",
			searchTerms: ["boat", "sea"]
		}, {
			title: "fas fa-fw fa-shipping-fast",
			searchTerms: []
		}, {
			title: "fab fa-shirtsinbulk",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-shoe-prints",
			searchTerms: ["feet", "footprints", "steps"]
		}, {
			title: "fas fa-fw fa-shopping-bag",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-shopping-basket",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-shopping-cart",
			searchTerms: ["buy", "checkout", "payment", "purchase"]
		}, {
			title: "fab fa-shopware",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-shower",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-shuttle-van",
			searchTerms: ["machine", "public-transportation", "transportation", "vehicle"]
		}, {
			title: "fas fa-fw fa-sign",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-sign-in-alt",
			searchTerms: ["arrow", "enter", "join", "log in", "login", "sign in", "sign up", "sign-in", "signin", "signup"]
		}, {
			title: "fas fa-fw fa-sign-language",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-sign-out-alt",
			searchTerms: ["arrow", "exit", "leave", "log out", "logout", "sign-out"]
		}, {
			title: "fas fa-fw fa-signal",
			searchTerms: ["bars", "graph", "online", "status"]
		}, {
			title: "fas fa-fw fa-signature",
			...
			title: "fas fa-fw fa-snowflake",
			searchTerms: ["precipitation", "seasonal", "winter"]
		}, {
			title: "far fa-snowflake",
			searchTerms: ["precipitation", "seasonal", "winter"]
		}, {
			title: "fas fa-fw fa-socks",
			searchTerms: ["business socks", "business time", "flight of the conchords", "wednesday"]
		}, {
			title: "fas fa-fw fa-solar-panel",
			searchTerms: ["clean", "eco-friendly", "energy", "green", "sun"]
		}, {
			title: "fas fa-fw fa-sort",
			searchTerms: ["order"]
		}, {
			title: "fas fa-fw fa-sort-alpha-down",
			searchTerms: ["sort-alpha-asc"]
		}, {
			title: "fas fa-fw fa-sort-alpha-up",
			searchTerms: ["sort-alpha-desc"]
		}, {
			title: "fas fa-fw fa-sort-amount-down",
			searchTerms: ["sort-amount-asc"]
		}, {
			title: "fas fa-fw fa-sort-amount-up",
			searchTerms: ["sort-amount-desc"]
		}, {
			title: "fas fa-fw fa-sort-down",
			searchTerms: ["arrow", "descending", "sort-desc"]
		}, {
			title: "fas fa-fw fa-sort-numeric-down",
			searchTerms: ["numbers", "sort-numeric-asc"]
		}, {
			title: "fas fa-fw fa-sort-numeric-up",
			searchTerms: ["numbers", "sort-numeric-desc"]
		}, {
			title: "fas fa-fw fa-sort-up",
			searchTerms: ["arrow", "ascending", "sort-asc"]
		}, {
			title: "fab fa-soundcloud",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-spa",
			searchTerms: ["flora", "mindfullness", "plant", "wellness"]
		}, {
			title: "fas fa-fw fa-space-shuttle",
			searchTerms: ["astronaut", "machine", "nasa", "rocket", "transportation"]
		}, {
			title: "fab fa-speakap",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-spider",
			searchTerms: ["arachnid", "bug", "charlotte", "crawl", "eight", "halloween", "holiday"]
		}, {
			title: "fas fa-fw fa-spinner",
			searchTerms: ["loading", "progress"]
		}, {
			title: "fas fa-fw fa-splotch",
			searchTerms: []
		}, {
			title: "fab fa-spotify",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-spray-can",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-square",
			searchTerms: ["block", "box"]
		}, {
			title: "far fa-square",
			searchTerms: ["block", "box"]
		}, {
			title: "fas fa-fw fa-square-full",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-square-root-alt",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-stamp",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-star",
			searchTerms: ["achievement", "award", "favorite", "important", "night", "rating", "score"]
		}, {
			title: "far fa-star",
			searchTerms: ["achievement", "award", "favorite", "important", "night", "rating", "score"]
		}, {
			title: "fas fa-fw fa-star-and-crescent",
			searchTerms: ["islam", "muslim"]
		}, {
			title: "fas fa-fw fa-star-half",
			searchTerms: ["achievement", "award", "rating", "score", "star-half-empty", "star-half-full"]
		}, {
			title: "far fa-star-half",
			searchTerms: ["achievement", "award", "rating", "score", "star-half-empty", "star-half-full"]
		}, {
			title: "fas fa-fw fa-star-half-alt",
			searchTerms: ["achievement", "award", "rating", "score", "star-half-empty", "star-half-full"]
		}, {
			title: "fas fa-fw fa-star-of-david",
			searchTerms: ["jewish", "judaism"]
		}, {
			title: "fas fa-fw fa-star-of-life",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-step-backward",
			searchTerms: ["beginning", "first", "previous", "rewind", "start"]
		}, {
			title: "fas fa-fw fa-step-forward",
			searchTerms: ["end", "last", "next"]
		}, {
			title: "fas fa-fw fa-stethoscope",
			searchTerms: []
		}, {
			title: "fab fa-sticker-mule",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-sticky-note",
			searchTerms: []
		}, {
			title: "far fa-sticky-note",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-stop",
			searchTerms: ["block", "box", "square"]
		}, {
			title: "fas fa-fw fa-stop-circle",
			searchTerms: []
		}, {
			title: "far fa-stop-circle",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-stopwatch",
			searchTerms: ["time"]
		}, {
			title: "fas fa-fw fa-store",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-store-alt",
			searchTerms: []
		}, {
			title: "fab fa-strava",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-stream",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-street-view",
			searchTerms: ["map"]
		}, {
			title: "fas fa-fw fa-strikethrough",
			searchTerms: []
		}, {
			title: "fab fa-stripe",
			searchTerms: []
			...
			title: "fas fa-fw fa-stroopwafel",
			...
			title: "fas fa-fw fa-subscript",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-subway",
			searchTerms: ["machine", "railway", "train", "transportation", "vehicle"]
		}, {
			title: "fas fa-fw fa-suitcase",
			searchTerms: ["baggage", "luggage", "move", "suitcase", "travel", "trip"]
		}, {
			title: "fas fa-fw fa-suitcase-rolling",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-sun",
			...
			title: "fas fa-fw fa-superscript",
			searchTerms: ["exponential"]
		}, {
			title: "fab fa-supple",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-surprise",
			searchTerms: ["emoticon", "face", "shocked"]
		}, {
			title: "far fa-surprise",
			searchTerms: ["emoticon", "face", "shocked"]
		}, {
			title: "fas fa-fw fa-swatchbook",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-swimmer",
			searchTerms: ["athlete", "head", "man", "person", "water"]
		}, {
			title: "fas fa-fw fa-swimming-pool",
			searchTerms: ["ladder", "recreation", "water"]
		}, {
			title: "fas fa-fw fa-synagogue",
			searchTerms: ["building", "jewish", "judaism", "star of david", "temple"]
		}, {
			title: "fas fa-fw fa-sync",
			searchTerms: ["exchange", "refresh", "reload", "rotate", "swap"]
		}, {
			title: "fas fa-fw fa-sync-alt",
			searchTerms: ["refresh", "reload", "rotate"]
		}, {
			title: "fas fa-fw fa-syringe",
			searchTerms: ["immunizations", "needle"]
		}, {
			title: "fas fa-fw fa-table",
			searchTerms: ["data", "excel", "spreadsheet"]
		}, {
			title: "fas fa-fw fa-table-tennis",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-tablet",
			searchTerms: ["apple", "device", "ipad", "kindle", "screen"]
		}, {
			title: "fas fa-fw fa-tablet-alt",
			searchTerms: ["apple", "device", "ipad", "kindle", "screen"]
		}, {
			title: "fas fa-fw fa-tablets",
			searchTerms: ["drugs", "medicine"]
		}, {
			title: "fas fa-fw fa-tachometer-alt",
			searchTerms: ["dashboard", "tachometer"]
		}, {
			title: "fas fa-fw fa-tag",
			searchTerms: ["label"]
		}, {
			title: "fas fa-fw fa-tags",
			searchTerms: ["labels"]
		}, {
			title: "fas fa-fw fa-tape",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-tasks",
			searchTerms: ["downloading", "downloads", "loading", "progress", "settings"]
		}, {
			title: "fas fa-fw fa-taxi",
			searchTerms: ["cab", "cabbie", "car", "car service", "lyft", "machine", "transportation", "uber", "vehicle"]
		}, {
			title: "fab fa-teamspeak",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-teeth",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-teeth-open",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-temperature-high",
			searchTerms: ["mercury", "thermometer", "warm"]
		}, {
			title: "fas fa-fw fa-temperature-low",
			searchTerms: ["cool", "mercury", "thermometer"]
		}, {
			title: "fab fa-tencent-weibo",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-terminal",
			searchTerms: ["code", "command", "console", "prompt"]
		}, {
			title: "fas fa-fw fa-text-height",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-text-width",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-th",
			searchTerms: ["blocks", "boxes", "grid", "squares"]
		}, {
			title: "fas fa-fw fa-th-large",
			searchTerms: ["blocks", "boxes", "grid", "squares"]
		}, {
			title: "fas fa-fw fa-th-list",
			searchTerms: ["checklist", "completed", "done", "finished", "ol", "todo", "ul"]
		}, {
			title: "fab fa-the-red-yeti",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-theater-masks",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-trophy",
			searchTerms: ["achievement", "award", "cup", "game", "winner"]
		}, {
			title: "fas fa-fw fa-truck",
			searchTerms: ["delivery", "shipping"]
		}, {
			title: "fas fa-fw fa-truck-loading",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-truck-monster",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-truck-moving",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-truck-pickup",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-tshirt",
			searchTerms: ["cloth", "clothing"]
		}, {
			title: "fas fa-fw fa-tty",
			searchTerms: []
		}, {
			title: "fab fa-tumblr",
			searchTerms: []
			...
			title: "fas fa-fw fa-umbrella",
			searchTerms: ["protection", "rain"]
		}, {
			title: "fas fa-fw fa-umbrella-beach",
			searchTerms: ["protection", "recreation", "sun"]
		}, {
			title: "fas fa-fw fa-underline",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-undo",
			searchTerms: ["back", "control z", "exchange", "oops", "return", "rotate", "swap"]
		}, {
			title: "fas fa-fw fa-undo-alt",
			searchTerms: ["back", "control z", "exchange", "oops", "return", "swap"]
		}, {
			title: "fab fa-uniregistry",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-universal-access",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-university",
			searchTerms: ["bank", "institution"]
		}, {
			title: "fas fa-fw fa-unlink",
			searchTerms: ["chain", "chain-broken", "remove"]
		}, {
			title: "fas fa-fw fa-unlock",
			searchTerms: ["admin", "lock", "password", "protect"]
		}, {
			title: "fas fa-fw fa-unlock-alt",
			searchTerms: ["admin", "lock", "password", "protect"]
		}, {
			title: "fab fa-untappd",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-upload",
			searchTerms: ["export", "publish"]
		}, {
			title: "fab fa-usb",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user",
			searchTerms: ["account", "avatar", "head", "human", "man", "person", "profile"]
		}, {
			title: "far fa-user",
			searchTerms: ["account", "avatar", "head", "human", "man", "person", "profile"]
		}, {
			title: "fas fa-fw fa-user-alt",
			searchTerms: ["account", "avatar", "head", "human", "man", "person", "profile"]
		}, {
			title: "fas fa-fw fa-user-alt-slash",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-astronaut",
			searchTerms: ["avatar", "clothing", "cosmonaut", "space", "suit"]
		}, {
			title: "fas fa-fw fa-user-check",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-circle",
			searchTerms: ["account", "avatar", "head", "human", "man", "person", "profile"]
		}, {
			title: "far fa-user-circle",
			searchTerms: ["account", "avatar", "head", "human", "man", "person", "profile"]
		}, {
			title: "fas fa-fw fa-user-clock",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-cog",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-edit",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-friends",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-graduate",
			searchTerms: ["cap", "clothing", "commencement", "gown", "graduation", "student"]
		}, {
			title: "fas fa-fw fa-user-injured",
			searchTerms: ["cast", "ouch", "sling"]
		}, {
			title: "fas fa-fw fa-user-lock",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-md",
			searchTerms: ["doctor", "job", "medical", "nurse", "occupation", "profile"]
		}, {
			title: "fas fa-fw fa-user-minus",
			searchTerms: ["delete", "negative", "remove"]
		}, {
			title: "fas fa-fw fa-user-ninja",
			searchTerms: ["assassin", "avatar", "dangerous", "deadly", "sneaky"]
		}, {
			title: "fas fa-fw fa-user-plus",
			searchTerms: ["positive", "sign up", "signup"]
		}, {
			title: "fas fa-fw fa-user-secret",
			searchTerms: ["clothing", "coat", "hat", "incognito", "privacy", "spy", "whisper"]
		}, {
			title: "fas fa-fw fa-user-shield",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-slash",
			searchTerms: ["ban", "remove"]
		}, {
			title: "fas fa-fw fa-user-tag",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-user-tie",
			searchTerms: ["avatar", "business", "clothing", "formal"]
		}, {
			title: "fas fa-fw fa-user-times",
			searchTerms: ["archive", "delete", "remove", "x"]
		}, {
			title: "fas fa-fw fa-users",
			searchTerms: ["people", "persons", "profiles"]
		}, {
			title: "fas fa-fw fa-users-cog",
			searchTerms: []
		}, {
			title: "fab fa-ussunnah",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-utensil-spoon",
			searchTerms: ["spoon"]
		}, {
			title: "fas fa-fw fa-utensils",
			searchTerms: ["cutlery", "dinner", "eat", "food", "knife", "restaurant", "spoon"]
		}, {
			title: "fab fa-vaadin",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-vector-square",
			searchTerms: ["anchors", "lines", "object"]
		}, {
			title: "fas fa-fw fa-venus",
			searchTerms: ["female"]
		}, {
			title: "fas fa-fw fa-venus-double",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-venus-mars",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-vial",
			searchTerms: ["test tube"]
		}, {
			title: "fas fa-fw fa-vials",
			searchTerms: ["lab results", "test tubes"]
		}, {
			title: "fab fa-viber",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-video",
			searchTerms: ["camera", "film", "movie", "record", "video-camera"]
		}, {
			title: "fas fa-fw fa-video-slash",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-vihara",
			...
			title: "fas fa-fw fa-volleyball-ball",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-volume-down",
			searchTerms: ["audio", "lower", "music", "quieter", "sound", "speaker"]
		}, {
			title: "fas fa-fw fa-volume-mute",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-volume-off",
			searchTerms: ["audio", "music", "mute", "sound"]
		}, {
			title: "fas fa-fw fa-volume-up",
			searchTerms: ["audio", "higher", "louder", "music", "sound", "speaker"]
		}, {
			title: "fas fa-fw fa-vote-yea",
			searchTerms: ["accept", "cast", "election", "politics", "positive", "yes"]
		}, {
			title: "fas fa-fw fa-vr-cardboard",
			searchTerms: ["google", "reality", "virtual"]
		}, {
			title: "fab fa-vuejs",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-walking",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-wallet",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-warehouse",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-water",
			searchTerms: []
		}, {
			title: "fab fa-weebly",
			searchTerms: []
			...
			title: "fas fa-fw fa-weight",
			searchTerms: ["measurement", "scale", "weight"]
		}, {
			title: "fas fa-fw fa-weight-hanging",
			...
			title: "fas fa-fw fa-wheelchair",
			searchTerms: ["handicap", "person"]
		}, {
			title: "fab fa-whmcs",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-wifi",
			searchTerms: []
		}, {
			title: "fab fa-wikipedia-w",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-wind",
			searchTerms: ["air", "blow", "breeze", "fall", "seasonal"]
		}, {
			title: "fas fa-fw fa-window-close",
			searchTerms: []
		}, {
			title: "far fa-window-close",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-window-maximize",
			searchTerms: []
		}, {
			title: "far fa-window-maximize",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-window-minimize",
			searchTerms: []
		}, {
			title: "far fa-window-minimize",
			searchTerms: []
		}, {
			title: "fas fa-fw fa-window-restore",
			searchTerms: []
		}, {
			...
			title: "fas fa-fw fa-wine-bottle",
			searchTerms: ["alcohol", "beverage", "drink", "glass", "grapes"]
		}, {
			title: "fas fa-fw fa-wine-glass",
			searchTerms: ["alcohol", "beverage", "drink", "grapes"]
		}, {
			title: "fas fa-fw fa-wine-glass-alt",
			searchTerms: ["alcohol", "beverage", "drink", "grapes"]
		}, {
			title: "fab fa-wix",
			searchTerms: []
			...
			title: "fas fa-fw fa-wrench",
			searchTerms: ["fix", "settings", "spanner", "tool", "update"]
		}, {
			title: "fas fa-fw fa-x-ray",
			...
			title: "fas fa-fw fa-yen-sign",
			searchTerms: ["jpy", "money"]
		}, {
			title: "fas fa-fw fa-yin-yang",
