            ...
            <div class="col-6">
              <table class="table table-borderless mb-0">
                <tr class="d-flex">
                  ...
                  <td class="col-6">
                    <select class="form-control" name="jenis" id="jenis">
                      ...
                      <option value="Karyawan" <?= set_select('jenis', 'Karyawan', $input->jenis == 'Karyawan' && empty(old('jenis'))) ?>>Karyawan</option>
                      <option value="Pejabat Struktural" <?= set_select('jenis', 'Pejabat Struktural', $input->jenis == 'Pejabat Struktural' && empty(old('jenis'))) ?>>Pejabat Struktural</option>
                    </select>
                ...
                <tr class="d-flex">
                  ...
                  <td class="col-6"><input type="date" name="periode_penilaian_awal" class="form-control" value="<?= set_value('periode_penilaian_awal', $input->periode_penilaian_awal) ?>"></td>
                </tr>
                <tr class="d-flex">
                  <td class="col-5">Periode Penilaian Akhir</td>
                  <td class="col-6"><input type="date" name="periode_penilaian_akhir" class="form-control" value="<?= set_value('periode_penilaian_akhir', $input->periode_penilaian_akhir) ?>"></td>
                </tr>
              </table>
            </div>
            <div class="col-6">
              <table class="table table-borderless mb-0">
                <tr class="d-flex">
                  ...
                  <td class="col-6"><input type="date" name="tanggal_mulai" class="form-control" value="<?= set_value('tanggal_mulai', $input->tanggal_mulai) ?>"></td>
                </tr>
                <tr class="d-flex">
                  <td class="col-5">Tanggal Selesai Penilaian</td>
                  <td class="col-6"><input type="date" name="tanggal_selesai" class="form-control" value="<?= set_value('tanggal_selesai', $input->tanggal_selesai) ?>"></td>
                </tr>
              </table>
            </div>
          </div>
