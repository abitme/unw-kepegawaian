  ...
  <div class="col-md-12">
    <div class="card shadow mb-3">
      ...
      <div class="card-body table-responsive">
        ...
        <form action="<?= base_url("setting-penilaian/$periode->id/upsert") ?>" method="post">
          <?= csrf_field() ?>
            ...
            <div class="col-6">
              <table class="table table-borderless mb-0">
                <tr class="d-flex">
                  ...
                  <td><input type="date" name="periode_penilaian_awal" class="form-control" value="<?= set_value('periode_penilaian_awal', $penilaian_setting->periode_penilaian_awal ?? '') ?>"></td>
                </tr>
                <tr class="d-flex">
                  <td class="col-5">Periode Penilaian Akhir</td>
                  <td><input type="date" name="periode_penilaian_akhir" class="form-control" value="<?= set_value('periode_penilaian_akhir', $penilaian_setting->periode_penilaian_akhir ?? '') ?>"></td>
                </tr>
                <tr class="d-flex">
