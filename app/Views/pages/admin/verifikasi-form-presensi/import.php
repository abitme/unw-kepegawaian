...
<div class="row">
	<div class="col-md-12">
		<a href="<?= base_url("assets/files/jabatan-struktural/template-jabatan-struktural.xls"); ?>" class="btn btn-sm btn-success mb-3">
				...
				<div class="card-body table-bordered table-responsive">
					...
					<table class="table table-hover" style="overflow-x:auto;">
						<thead>
							<tr>
								...
								<th scope="col">NIK Pegawai Verfikasi</th>
								<th scope="col">Nama Pegawai Verfikasi</th>
							</tr>
						</thead>
						<tbody>
							<?= $preview ?>
					...
					<?php if (empty($error)) : ?>
						<form method="post" action="<?= $form_action ?>">
							<a href="<?= base_url('jabatan-struktural') ?>" class="btn btn-light">Cancel</a>
