...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	...
	public $adminEmail               = 'm.tsabitna97@gmail.com'; // Admin Email, admin@example.com
	public $defaultGroup             = 'Pegawai';           // Default group, use name
	public $adminGroup               = 'SuperAdmin';       // Default administrators group, use name
	...
	public $emailConfig = [
		...
		'SMTPUser'  	=> 'm.tsabitna97@gmail.com',
		'SMTPPass'  	=> 'seoyeji1!',
		'SMTPPort'  	=> '465',
		'SMTPCrypto' 	=> 'ssl',
		'mailType' 		=> 'html',
