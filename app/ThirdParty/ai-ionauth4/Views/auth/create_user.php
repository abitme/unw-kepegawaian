  ...
  <div class="col-md-7 mx-auto">
    ...
    <div class="card shadow mb-4">
      <div class="card-header text-center">
        <h6 class="m-0 font-weight-bold text-primary">Form <?= lang('Auth.create_user_heading') ?></h6>
      </div>
      <div class="card-body">
        <?php echo form_open('users/create'); ?>

        <div class="form-group">
          <?php echo form_label(lang('Auth.create_user_name_label'), 'name'); ?>
        ...
        <div class="form-group id_pegawai">
          ...
          <?= form_dropdown('id_pegawai', getDropdownList('pegawai', ['id', 'nama_pegawai'], '', '- Pilih Pegawai -', 'id', 'asc', '', 'base_unw'), set_value('id_pegawai'), ['class' => 'form-control access', 'id' => 'id_pegawai', 'style' => 'width:100%']) ?>
        </div>

        <div class="float-left">
          <a href="<?= base_url('users') ?>" class="btn btn-back">Cancel</a>
          <button type="submit" class="btn btn-primary btn-user"><?= lang('Auth.create_user_submit_btn') ?></button>
        </div>
